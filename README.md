...
- Central infrastructure reference (ports, tunnels, DNS, launch agents for every project) lives at `~/ServerOps/servers.md`. Update that file whenever you add another service.
